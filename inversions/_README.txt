This folder contains files related to SLiM manual recipe 14.4.  The current version of this recipe was developed by Vince Buffalo, Peter Ralph, and Andy Kern.  For further discussion you can see:
...
- vince_inversion_final.slim : the final SLiM script by Vince, which differs from SLiM recipe 14.4 both in some cosmetic ways, and in using tree-sequence recording to record the results of runs

- inversion_recipe.ipynb : an iPython notebook to analyze results from that vince_inversion_final.slim
...
If you have further questions, please contact the authors.  Thanks to Vince, Peter, and Andy for contributing this improved recipe!
