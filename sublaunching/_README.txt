...
aggregateLocalAncestry.R : R script to replicate recipe 13.9 1000 times, aggregate the results, and produce a plot

gen_replicates.py : Python script to perform replicated runs and tabulate a binary metric from their output
